...
public class XMLExchangeStrategyTest extends BaseExchangeStrategyTest {
    @Before
    public void setUp() throws Exception {
        strategy = new XMLExchangeStrategy();
    }
    ...
    public void ParseSearchResultWithValidData() throws Exception {
        ...
        List<Movie> expected = Arrays.asList(
                new Movie("Inception: The IMAX Experience", 2010, "tt1375666"),
                ...
                new Movie("Fraud in the Inception", 2013, "tt2278951"),
